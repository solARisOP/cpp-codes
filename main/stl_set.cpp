...
//a.erase(x) – Remove all instance of element from multiset having same value.
//a.erase(a.find(x)) – Remove only one instance of element from multiset having same value.